                ...
                >
                  <View
                    style={[
                      ...
                      {
                        backgroundColor: theme === 'dark' ? 'rgba(15, 15, 15, 0.8)' : designTokens.brand.primary,
                        borderColor: theme === 'dark' ? 'rgba(38, 38, 38, 0.6)' : 'transparent',
                  ...
                  >
                    <Text style={[
                      ...
                      { 
                        color: theme === 'dark' ? '#ffffff' : designTokens.text.primary,
                        fontFamily: 'Nunito-SemiBold'
                      }
                    ]}>
                      Get Started
                  ...
                  <View
                    style={[
                      styles.primaryButton,
                      {
                        ...
                        borderColor: theme === 'dark' ? 'rgba(51, 51, 51, 0.6)' : 'rgba(203, 213, 225, 0.5)',
                        borderWidth: theme === 'dark' ? 1 : 0.5,
                        shadowColor: theme === 'dark' ? '#000000' : '#000000',
            ...
            >
              ...
              >
                <Text style={[
                  ...
                  Already have an account? <Text style={[styles.loginLinkBold, { 
